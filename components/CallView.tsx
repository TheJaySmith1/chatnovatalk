  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-2xl z-50 flex flex-col items-center justify-center p-4 animate-fade-in">
      <div className="w-full max-w-4xl h-full flex flex-col">
       ...
       {/* FIX: The 'jsx' prop on <style> is for styled-jsx, which is not used here. Removing it fixes a TypeScript error and makes the styles global, which is fine for this animation. */}
       <style>{`
        @keyframes fade-in {
          from { opacity: 0; }
          to { opacity: 1; }
